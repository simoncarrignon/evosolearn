...
```{r resample-vostok,fig.cap="Interpoling missing data for different environment using NGRIP2 Power Sprectral Density",out.width="25%",fig.show="hold"}
...
legend("topright",legend=c("original + interpolate","original","ngrip2"),lwd=1,col=c("black","red","green"))
```
