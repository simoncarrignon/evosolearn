...
allparameters[["k_y"]]=c(1,2,4)
allparameters[["k_z"]]=c(.5,1,2)
                    ...
                    parLapply(cl,1:nrow(parameters),function(v,parameters)
                              {
                                  ...
                                  c(as.list(getSummary(summary,nstep=3,vars=c(paste0("mean_",genes),paste0("var_",genes),"N","mean_w","mean_p","theta","prop_y","prop_z","prop_yz"))),filename=filename_mat)
