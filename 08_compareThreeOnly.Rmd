...
```{r,fig.width=10,fig.height=10}
plotAllVariableSummaries(moving_theta,E=0,estimate=eq2833b,var="mean_x") #we use only simulations without noise
plotAllVariableSummaries(moving_theta,E=0,estimate=eq2833b,var="mean_y") #we use only simulations without noise
plotAllVariableSummaries(moving_theta,E=0,estimate=eq2833b,var="mean_z") #we use only simulations without noise
```
