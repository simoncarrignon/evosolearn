# Explore environments, dataset and models 
...
```{r cov,fig.cap="autocorrelation",fig.width=10}
    par(mfrow=c(1,3))
...
Trying to centralise the exploration of different real environments and their properties
