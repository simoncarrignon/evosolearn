...
E_x=c(0.08,0.15,.25,.50,.75) #sigma for whitehead, E[x] pour nous
C_v=1-c(0.01,0.03,0.05,0.07,0.1)
C_h=C_v-c(0.01,0.03,0.05,0.07,0.1)
C_i=C_h-c(0.01,0.03,0.05,0.07,0.1)
