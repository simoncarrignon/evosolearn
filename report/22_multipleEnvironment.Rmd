...
```{r}
    ...
    namesRealEnv=c("vostok","ngrip2","martrat")
...
basecaption=paste0('(from left to right $\\\\sigma_s =',paste0(allSigmas, collapse = ","),'$, real E: $E_x=0.1,E_y=1,E_z=.5$, SLS:{{sls}} Environment:{{env}})')
a=c(
    "### {{sls}}",
    "### Function {{fun}}",
    '```{r}',
    ...
    '```',
    "#### Last step summary",
    paste0('```{r summary-last-{{id}}, out.width = "33%", fig.cap="Summary output for last step',basecaption,'",fig.show="hold",fig.link=allsummaries}'),
    ...
    '```',
    "#### Vertical summary",
    paste0('```{r traj-{{id}}, out.width = "33%", fig.cap="Summarized vertical trajectories',basecaption,'",fig.show="hold",fig.link=allimg}'),
    ...
    '```',
    "#### Vertical run indiv",
    paste0('```{r traj-ind-{{id}}, out.width = "33%", fig.cap="Vertical trajectories for 20 individual runs',basecaption,'",fig.show="hold",fig.link=allimg}'),
    'idexpe="{{id}}"',
    'knitr::include_graphics(as.character(allimg))',
    '```',
    '```{r}',
    ...
    '```',
    "#### Vertical run indiv",
    paste0('```{r traj-indN-{{id}}, out.width = "33%", fig.cap="Vertical trajectories for 20 individual runs, $N_e$',basecaption,'",fig.show="hold",fig.link=allimg}'),
    'idexpe="{{id}}"',
    'knitr::include_graphics(as.character(allimg))',
    '```'
    )
