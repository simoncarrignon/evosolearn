...
```{r interpolNgripFull, fig.width=14,out.width = "100%",fig.cap="interpolation linear + noise full dataset", fig.link="_main_files/figure-html/interpolNgripFull-1.png"}
	...
	#linear + noise
    newtN=interpolate(lr04$dTsVscales,lr04$year,finalres=250,omega=omw,delta=dtw)$data
...
## Combine Real and simulated noise
...
To know the amplitude (ie the variation) of the noise we add to the line, we compute  the variation of sliding windows of the size of the gap.
